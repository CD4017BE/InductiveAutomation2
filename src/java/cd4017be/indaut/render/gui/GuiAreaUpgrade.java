...
import cd4017be.indaut.item.ItemSelectionTool;
...
public class GuiAreaUpgrade extends GuiMachine {
	...
	public void initGui() {
		...
		guiComps.add(new Text<Object[]>(6, 26, 16, 88, 16, "areaCfg.size_").setTooltip("areaCfg.size"));
		guiComps.add(new Text<Object[]>(7, 26, 34, 88, 16, "areaCfg.dist_").setTooltip("areaCfg.dist"));
		guiComps.add(new Text<Integer>(8, 26, 52, 88, 16, "areaCfg.Umax_").setTooltip("areaCfg.Umax"));
