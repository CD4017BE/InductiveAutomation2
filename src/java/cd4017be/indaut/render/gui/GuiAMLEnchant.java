...
import cd4017be.indaut.item.ItemAntimatterLaser.Enchantments;
...
public class GuiAMLEnchant extends GuiMachine {
	...
	public void initGui() {
		...
		this.ySize = 132;
		super.initGui();
		guiComps.add(new Text<Object[]>(0, 62, 16, 88, 16, "amlE.use").setTooltip("amlE.info"));//
	}
	...
	public void updateScreen() {
		super.updateScreen();
		Enchantments ench = new Enchantments(inv.mainInventory.get(inv.currentItem));
		AMuse = ench.amMult * 8;
		Euse = ench.Euse;
	}
