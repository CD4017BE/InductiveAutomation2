...
import cd4017be.indaut.tileentity.GasPipe;
...
public class GuiGasPipe extends GuiMachine {
	...
	protected Object getDisplVar(int id) {
		return new Object[]{
			TooltipUtil.formatNumber(data.V, 3),
			TooltipUtil.formatNumber(data.P(), 4, 0),
			data.T - 273.15F,
			TooltipUtil.formatNumber(data.nR / 8.314472F, 3, 0)
		};
	}
