...
public class ItemJetpack extends ItemArmor implements ISpecialArmor {
	...
	public static double[] absorption = {0, 0.24D, 0.28D, 0.32D, 0.32D};
	private static final int[] displayArmor = {0, 6, 7, 8, 8};
	public static int[] durability = {0, 240, 360, 480, 0};
	...
	public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
		return new ArmorProperties(0, absorption[this.armor], getMaxDamage(armor) - armor.getItemDamage());
	}
	...
	private int updateEnergy(NBTTagCompound data, InventoryPlayer inv) {
		...
		for (int i = 0; energy > 0 && i < inv.mainInventory.size(); i++)
