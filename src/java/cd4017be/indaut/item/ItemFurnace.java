...
import cd4017be.indaut.render.gui.GuiPortableFurnace;
...
public class ItemFurnace extends ItemFilteredSubInventory implements IEnergyItem, IItemStorage, IGuiItem, ClientItemPacketReceiver {
